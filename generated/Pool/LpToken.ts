...
export class GrantPoolRoleCall extends ethereum.Call {
  get inputs(): GrantPoolRoleCall__Inputs {
    return new GrantPoolRoleCall__Inputs(this);
  }

  get outputs(): GrantPoolRoleCall__Outputs {
    return new GrantPoolRoleCall__Outputs(this);
  }
}

export class GrantPoolRoleCall__Inputs {
  _call: GrantPoolRoleCall;

  constructor(call: GrantPoolRoleCall) {
    this._call = call;
  }
}

export class GrantPoolRoleCall__Outputs {
  _call: GrantPoolRoleCall;
